...
export function settleResponse(ctx) {
...
export function createFetchMiddleware(yabRequestInit) {
  var _this = this;
  // TODO:
  var browserFetch = window.fetch;
  return function(ctx) {
    return __awaiter(_this, void 0, void 0, function() {
      var requestInit, response, nativefetchError_1, error_1;
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 6, , 7]);
            requestInit = getRequestInit(yabRequestInit);
